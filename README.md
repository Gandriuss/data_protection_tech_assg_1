...
## Getting Started
0. ensure you have an NVIDIA GPU and cuda installed.
1. execute `prepare_for_experiment.sh` - downloads 'CelebA' dataset and installs necessary python libraries.
...
Code provided by the paper's authors has been only modified in:
